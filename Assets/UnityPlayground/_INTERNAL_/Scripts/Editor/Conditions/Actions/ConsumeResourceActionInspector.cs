...
public class ConsumeResourceActionInspector : ConditionInspectorBase
{
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("givePoints"));
		EditorGUILayout.PropertyField(serializedObject.FindProperty("destroyWhenActivated"));
